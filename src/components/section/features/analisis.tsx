        ...
        <>
            <main>
                <div className={`${poppins.className} w-full grid grid-cols-12 items-start justify-center px-4 py-8 pb-0 relative gap-2`}>
                    ...
                    <div className='w-full bg-transparent col-span-4 grid grid-cols-1'>
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" id="Clock--Streamline-Font-Awesome" height="16" width="16">
                                            <defs>
                                                <linearGradient id="gradient" x1="0" x2="0" y1="0" y2="1">
                                                    <stop offset="0%" stop-color="#DF2727" />
                                                    <stop offset="100%" stop-color="#FF8080" />
                                                </linearGradient>
                                            </defs>
                                            <desc>Clock Streamline Icon: https://streamlinehq.com</desc>
                                            <path d="M8 0a8 8 0 1 1 0 16 8 8 0 1 1 0 -16zm-0.75 3.75v4.25c0 0.25 0.125 0.484375 0.334375 0.625l3 2c0.34375 0.23125 0.809375 0.1375 1.040625 -0.209375s0.1375 -0.809375 -0.209375 -1.040625L8.75 7.6V3.75c0 -0.415625 -0.334375 -0.75 -0.75 -0.75s-0.75 0.334375 -0.75 0.75z" fill="url(#gradient)" stroke-width="0.0313" />
                                        </svg>
